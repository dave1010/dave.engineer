...
(If this isn't easy to visualise then give Shapes.io a quick play.)
...
TODO: explore alternatives to human PR review
...
My view is that something fundamental has to change here. Something for another blog post.
...
TODO: verification becoming computational
...
Communication and governance aren’t steps themselves, but they enable and constrain every other step in the factory. When one step is done, how do we quickly and effectively move on to the next?

I expect AI could help significantly here but I'm yet to see much evidence of it.
...
TODO: explore decision-making bottlenecks
